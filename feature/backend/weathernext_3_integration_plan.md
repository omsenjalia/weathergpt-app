...
| `WEATHERNEXT_BQ_*` | Actual linked surface/station table IDs, correct dataset location, positive per-query maximum bytes billed; explicit columns, init-time bounds and dry runs. |
